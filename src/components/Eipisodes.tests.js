...
const epsData = [
    {
        ...
        "_embedded": {
          "episodes": [
            ...
            {
              "id": 1949380,
              "url": "http://www.tvmaze.com/episodes/1949380/stranger-things-4x03-chapter-three-you-snooze-you-lose",
...
test('Episodes component correctly renders', () => {

    //Arrange - render component and setup the mock data
    ...
    //rerender Episode component with season 2 (my epsData) selected 
    rerender( <Episodes episodes={epsData} />)

    //now data should be there after rerender

    expect(queryByText(/season 2, episode 9/i)).toBeInTheDocument();

    //Title should show
    expect(getByText(/Trick or treat, freak/i)).toBeInTheDocument();

    //Minutes should be in ALL of them
    expect(getAllByText(/60 minutes/i)[0]).toBeInTheDocument();

});

//Now to test.. All pass!